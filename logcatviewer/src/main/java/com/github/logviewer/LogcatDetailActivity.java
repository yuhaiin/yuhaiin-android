...
public class LogcatDetailActivity extends AppCompatActivity {
    ...
    public static void launch(Context context, LogItem log) {
        Intent intent = new Intent(context, LogcatDetailActivity.class).putExtra("log", log);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LogcatActivity.InitTheme(getApplicationContext(), getWindow());
        ...
        if (log != null)
            binding.content.setText(
                    String.format(Locale.getDefault(), CONTENT_TEMPLATE,
